        ...
        with connection.cursor() as cursor:
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS catgirl_records (
                    ...
                    group_id BIGINT NOT NULL,
                    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                    status VARCHAR(20) DEFAULT 'pending',  -- pending, confirmed, active
            ...
            cursor.execute("""
                CREATE TABLE IF NOT EXISTS duel_games (
                    ...
                    current_turn BIGINT NULL,
                    last_action_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
                    challenger_cards TEXT NULL,
                    challenged_cards TEXT NULL,
                    challenger_stand BOOLEAN DEFAULT FALSE,
                    challenged_stand BOOLEAN DEFAULT FALSE,
                    winner_id BIGINT NULL,
                    UNIQUE KEY unique_active_duel (challenger_id, challenged_id, group_id, status),
